#Taken from tutorial http://pythonforengineers.com/build-marvin-the-depressed-reddit-bot-in-python/
import praw
import re
import random
...
#Infinite loop to continue searching for new comments
for comment in subreddit.stream.comments():
    if re.search('Marvin Help', comment.body, re.IGNORECASE):
        print('Found a new commenter to help!!')
